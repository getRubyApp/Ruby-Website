...
export default function Home() {
	return (
		<>
			...
			<p className="text-center text-lg lg:text-xl my-2 max-w-xl text-balance mx-auto">
				Ruby is a beautifully designed news app for Apple platforms,
				built to be simple and easy to use.
			</p>

			<a
				className="flex items-center gap-2 rounded-full px-3 py-2 bg-black text-white dark:bg-white dark:text-black hover:bg-zinc-800 dark:hover:bg-zinc-200 transition ease-in-out group w-fit mx-auto"

...
export function Navbar() {
	return (
		<nav className="fixed top-0 left-0 w-full p-3 flex justify-center z-50">
			<div className="flex gap-4 justify-between items-center rounded-full backdrop-blur-lg bg-zinc-50/50 dark:bg-zinc-950/50 p-1 w-full md:w-fit border border-zinc-300/50 dark:border-zinc-700/50 drop-shadow-sm after:absolute after:inset-[1px] after:border-t-2 after:rounded-full after:border-white/10 after:-z-10">
				<Link
					href="/"
